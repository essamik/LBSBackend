...
public class DiscoveryRepositoryTest {
    ...
    private Discovery discovery301 = new Discovery("001", Discovery.DiscoverEvent.ENTER);
    private Discovery discovery302 = new Discovery("002", Discovery.DiscoverEvent.EXIT);
    private Discovery discovery303 = new Discovery("999", Discovery.DiscoverEvent.DWELL);
    private Discovery discovery304 = new Discovery("011", Discovery.DiscoverEvent.ENTER);
    private Discovery discovery305 = new Discovery("011", Discovery.DiscoverEvent.ENTER);
    ...
    public void createDiscovery() throws Exception {
        ...
        Discovery discoveryToCreate = new Discovery("beaconId", Discovery.DiscoverEvent.ENTER);
